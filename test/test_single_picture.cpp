...
TEST_F(SinglePicture, Load2Bit)
{
    ...
    upng_t *png = upng_new_from_file("./resources/checker_2bit.png");
    ASSERT_NE(nullptr, png);
    ASSERT_EQ(UPNG_EOK, upng_get_error(png));
...
TEST_F(SinglePicture, Load1Bit)
{
    ...
    upng_t *png = upng_new_from_file("./resources/checker_1bit.png");
    ASSERT_NE(nullptr, png);
    ASSERT_EQ(UPNG_EOK, upng_get_error(png));
...
{
    upng_t *png = upng_new_from_file("./resources/hidden_texts.png");
    ASSERT_NE(nullptr, png);
    ASSERT_EQ(UPNG_EOK, upng_decode_default(png));
